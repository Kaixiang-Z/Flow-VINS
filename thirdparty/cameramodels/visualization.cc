...
void CameraPoseVisualization::setScale(double s) { scale = s; }

void CameraPoseVisualization::setLineWidth(double width) { line_width = width; }
...
void CameraPoseVisualization::reset() { markers.clear(); }

void CameraPoseVisualization::publish_by(rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub,
